  const parseAmount = (val, multiplyThousands) => {
    let num = 0;
    ...
    if (multiplyThousands) num = num * 1000;
    return num;
  };
  console.log(parseAmount('50.000,00', true));
  console.log(parseAmount('50,000.00', true));
  console.log(parseAmount('50000', true));
  console.log(parseAmount('50000,00', true));
  console.log(parseAmount('500,00', true));
  console.log(parseAmount('500.00', true));
